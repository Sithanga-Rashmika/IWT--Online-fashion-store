...
<!--start return form-->
<center>
<form method = "post" action="ReturnItem.php">
	<table width="40%" border="2" style="background-color:#DCDCDC;">
		<tr>
			<th>No</th>
			<th>Item Code</th>
		...
		<tr>
			<td>01</td>
			<td><input type="text" name="Itemcode" placeholder="Enter code here" /></td>
	
		</tr>
		
	</table>
	<br><br>
	<h3 style ="margin-left:-369px">Reason return item</h3>
		
	<textarea name="Reason" rows =8 placeholder="reason..." style ="margin-left:-300px; width:350px"></textarea><br><br>
	<input type="submit" value="SUBMIT" style="width:200px; background-color:#00b36b; color: white;">
</form>
</center>
<br><br><br><br>
